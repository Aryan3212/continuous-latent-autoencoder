...
def main() -> None:
    ...
    x_de, y_de, _ = _load_embs(lm, args.dev_manifest, args.label_key, args.batch_size, seg, log_name="Gender dev", label_map=label_map)
    ...
    print(f"  [Gender] Embedding effective rank: {emb_stats['embed_effective_rank']:.2f} / {emb_stats['embed_dim']}", flush=True)
